...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add new "Live" tab that allows monitoring logs in real-time as they arrive. This feature helps users to observe the most recent log entries without manual refreshing, making troubleshooting and monitoring more efficient. See [#7046](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/7046).
...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add new "Live Logs" tab that enables real-time log monitoring. This new view allows users to observe log entries as they are ingested into the system without manual refreshing. See [#8438](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8438).
