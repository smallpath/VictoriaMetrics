...
* BUGFIX: [MetricsQL](https://docs.victoriametrics.com/victoriametrics/metricsql/): properly parse quoted utf-8 label names in parentheses. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8826) for details.
* BUGFIX: [MetricsQL](https://docs.victoriametrics.com/victoriametrics/metricsql/): properly parse metric name series selectors with `or` expressions. See [this issue](https://github.com/VictoriaMetrics/metricsql/issues/50) for details.
